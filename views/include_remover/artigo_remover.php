...
<body>
    ...
    <div class="escolha">
        <form  action="painel.php?pag=11" method="POST">
            <fieldset>
                <label for="escolhaPostagem" class="labelSelect">Selecione um artigo para remover</label>
    ...
    <section class="menuAdm">
        <section id="contato">
            <form  id="formPostagem" action="../bancoPhp/remover/artigo_remover_db.php?cd=<?php echo $id_select ?>" method="POST">
