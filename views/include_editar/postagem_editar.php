...
<body>
    ...
    <div class="escolha">
        <form  action="painel.php?pag=5" method="POST">
            <fieldset>
                <label for="escolhaPostagem" class="labelSelect">Selecione uma postagem para edição</label>
    ...
    <section class="menuAdm">
        <section id="contato">
            <form  id="formPostagem" action="../bancoPhp/alterar/postagem_alterar_db.php?cd=<?php echo $id_postagem ?>" method="POST">
