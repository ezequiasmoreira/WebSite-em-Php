...
<body>
    <header id="topo">
         ...
         <?php
            ...
            $sql =  "SELECT * FROM solicitacao WHERE id_solicitacao = '$opcao'";
    ...
    <section class="menuAdm">
        <section id="contato">
            <form  id="formPostagem" action="../bancoPhp/alterar/solicitacao_alterar_db.php?cd=<?php echo $opcao ?>" method="POST">
                
                <h1 id="titulo">Alterar solicitação de orçamento</h1>                
                ...
                <input id="ate" class="inputForm" name="atendido" type="radio" value="S" >
                <label class='labelAtendido' for="ate">Marcar como não atendido</label>
                <input id="ate" class="inputForm" name="atendido" type="radio" value="N" checked>
