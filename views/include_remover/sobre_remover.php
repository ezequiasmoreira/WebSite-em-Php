...
<body>
    ...
    <div class="escolha">
        <form  action="painel.php?pag=12" method="POST">
            <fieldset>
                <label for="escolhaPostagem" class="labelSelect">Selecione uma página para remover</label>
    ...
    <section class="menuAdm">
        <section id="contato">
            <form  id="formPostagem" action="../bancoPhp/remover/sobre_remover_db.php?cd=<?php echo $id_select ?>" method="POST">
